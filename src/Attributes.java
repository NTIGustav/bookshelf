...
public class Attributes {//Antribut
    BorrowBook borrowBook;
    Book[] books = new Book[4];
    User[] users = new User[2];
    public Attributes() { //Konstructorn --> skapar intanser --> skapar argumenten ^^
        ...
        Scanner scanner = new Scanner(System.in); //Läsa inmatning från användaren
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                default:
                    ...
                    break;
            }//Läs om tills använderaren skriver in 4 för att avsluta programet. Den skriver också ut en meny som berättar vad inmatningarna
        }//från 1-4 gör
    }
}
